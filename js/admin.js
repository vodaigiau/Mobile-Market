...
function layThongTinSanPhamTuTable(id) {
    ...
    var chip = tr[14].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["Apple", "Samsung", "Oppo", "Nokia", "Huawei", "Xiaomi","Realme", "Vivo", "Philips", "Acer", "MSI", "Asus","Coolpad", "HTC", "Motorola"];
    ...
    s += `
        ...
        <tr>
            ...
            <td>
                <select>
                    ...
                    <option value="giareonline" `+(sp.promo.name == 'giareonline'?'selected':'')+`>Hot sales</option>
        ...
        <tr>
            <td>Chip:</td>
            <td><input type="text" value="`+sp.detail.chip+`"></td>
        </tr>
        <tr>
            <td>CPU:</td>
