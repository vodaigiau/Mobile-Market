	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="lienhe.html"><i class="fa fa-phone"></i>Liên hệ 1800.2097</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addHeader() {
  document.write(`        
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/mobilemarket.jpg" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
  document.write(`
    ...
    <div class="copy-right">
        <p><a href="index.html"> HP Shop</a> - All rights reserved © 2023 - Designed by
            <span style="color: #eee; font-weight: bold">Franky D</span></p>
    </div>`);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Giảm 250k đơn hàng từ 6.5 triệu (trừ các sản phẩm Apple)</li>
                <li>Thanh toán linh hoạt: tiền mặt, visa / master, trả góp</li>
                <li>Trải nghiệm sản phẩm tại ngay tại cửa hàng</li>
                <li> Ưu đãi đến 800k khi mở thẻ VP Bank</li>
