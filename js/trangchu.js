window.onload = function () {
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('BEST SELLER', yellow_red, ['star=3', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('NEW!', blue, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('TRẢ GÓP 0%', yellow_red, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('HOTSALE', green, ['promo=giareonline', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIẢM GIÁ', yellow_red, ['promo=giamgia'], soLuong, div);
		addKhungSanPham('HÀNG CŨ GIÁ RẺ', green, ['price=0-3000000', 'sort=price'], soLuong, div);
	}
