...
function phanTich_URL_chiTietSanPham() {
    ...
    // Đổi title
    document.title = nameProduct + ' - Hoàng Phúc Shop';
...
function getDetailPromo(sp) {
    switch (sp.promo.name) {
        ...
        case 'giareonline':
            ...
            return `Sản phẩm sẽ được giảm ` + span + `₫ khi mua hàng online bằng thẻ VPBank hoặc tin nhắn SMS, Giảm thêm tới 1% cho thành viên HPmember`;
